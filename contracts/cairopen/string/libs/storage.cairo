...
from contracts.cairopen.string.string import String
from contracts.cairopen.string.libs.conversion import conversion_extract_last_char_from_ss
from contracts.cairopen.string.constants import SHORT_STRING_MAX_LEN, STRING_MAX_LEN
