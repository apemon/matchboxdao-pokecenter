...
@storage_var
func ERC721_owners_timestamp(token_id : Uint256) -> (timestamp : Uint256):
end
...
@view
func ownerTimestamp{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
    tokenId : Uint256
) -> (timestamp : Uint256):
    let (timestamp : Uint256) = ERC721_owners_timestamp.read(tokenId)
    return (timestamp)
end
...
func transferFrom{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(
    ...
    let (low, high) = split_64(block_timestamp)
    let timestamp = Uint256(low, high)
    ERC721_owners_timestamp.write(token_id=tokenId, value=timestamp)
    return ()
end
...
func burn{pedersen_ptr : HashBuiltin*, syscall_ptr : felt*, range_check_ptr}(tokenId : Uint256):
    ...
    ERC721_owners_timestamp.write(token_id=tokenId, value=Uint256(0, 0))
    return ()
end
